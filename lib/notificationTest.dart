...
class NotifTest extends StatefulWidget {
  const NotifTest({Key? key}) : super(key: key);
...
class _NotifTestState extends State<NotifTest> {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () async {
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context)=> HomePage(notificationAppLaunchDetails)));
    });
  }
...
Future<void> main() async {
  ...
  LinuxInitializationSettings(
    ...
    defaultIcon: AssetsLinuxIcon('assets/image/call.png'),
  );
...
class _HomePageState extends State<HomePage> {
    ...
    AndroidNotificationDetails(
      ...
      actions: <AndroidNotificationAction>[
        ...
        AndroidNotificationAction(
          ...
          icon: DrawableResourceAndroidBitmap('ic_stat_name'),
        ),
        AndroidNotificationAction(
          navigationActionId,
          'Action 3',
  ...
  static Future<void> _showGroupedNotifications() async {
    int id = 100;
  ...
  Future<void> _showNotificationWithCustomTimestamp() async {
    ...
    AndroidNotificationDetails(
      ...
      importance: Importance.max,
      priority: Priority.high,
      when: DateTime.now().millisecondsSinceEpoch - 120 * 10000,
    );
    final NotificationDetails notificationDetails =
    NotificationDetails(android: androidNotificationDetails);
    await flutterLocalNotificationsPlugin.show(
